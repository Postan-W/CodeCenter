...
# 定义一个RotatingFileHandler,最多备份10个日志文件(超过10个就把最老的删掉，添加新的)，每个日志文件最大maxBytes即最大字节数
file_handler = RotatingFileHandler("./logs/log.txt", maxBytes=1*1024 , backupCount=10)
