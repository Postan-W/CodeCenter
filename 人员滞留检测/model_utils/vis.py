...
def plot_tracking(image, tlwhs, obj_ids, scores=None, frame_id=0, ids2=None): #fps=0., ids2=None):
    ...
    cv2.putText(im, 'location: bonc frame: %d num: %d' % (frame_id, len(tlwhs)),
                (0, int(15 * text_scale)), cv2.FONT_HERSHEY_PLAIN, text_scale, (255, 255, 0), thickness=2)
